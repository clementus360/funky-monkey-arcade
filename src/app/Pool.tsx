    ...
    return (
        <section id="games" className='flex flex-col sm:grid sm:grid-cols-[1fr_1fr] gap-8 py-16 sm:py-0 sm:pb-24  sm:pr-24 items-center'>
            ...
            <div className='flex flex-col gap-4 px-8 sm:pl-0'>
                ...
                <p className='font-text text-xl sm:textvw-[20] text-text lineheight-[26]'>From intense matches to laid-back rounds with friends, our pool tables cater to diverse preferences and skill levels. So, if you&rsquo;re ready to break into a new level of fun, grab your cue and join us for an unforgettable gaming experience!</p>
            </div>
